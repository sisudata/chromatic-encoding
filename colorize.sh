...
tar -I "pzstd -p $total_parallelism" -cf ./svms-data/binary.tar.zst \
  ...
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{sm,ft,ht}1024.{data,indices,indptr,y}.bin \
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{sm,ft}1024.svm
...
rm \
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{data,indices,indptr,y}.bin \
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{sm,ft,ht}1024.{data,indices,indptr,y}.bin \
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{sm,ft,ht}1024.svm \
  ./svms-data/{url,kdda,kddb,kdd12}.{train,test}.{sm,ft,ht}1024.svm.field_dims.txt
